...
const features = [
  ...
  },
  {
    ...
    desc: "Plan, structure, and scale your content with data-driven AI insights",
    tag: "Phase 2 →",
    locked: true,
    ...
    icon: (
      <div style={{
        background: 'linear-gradient(135deg, #4A6FE3 0%, #7B9FF5 100%)',
        height: '200px',
        width: '100%',
        ...
        >
          ...
          {/* Bar 1 */}
          <rect x="20" y="85" width="18" height="25" 
                rx="4" fill="rgba(255,255,255,0.35)"/>

          {/* Bar 2 */}
          <rect x="46" y="65" width="18" height="45" 
                rx="4" fill="rgba(255,255,255,0.5)"/>

          {/* Bar 3 */}
          <rect x="72" y="42" width="18" height="68" 
                rx="4" fill="rgba(255,255,255,0.7)"/>

          {/* Bar 4 (tallest) */}
          <rect x="98" y="20" width="18" height="90" 
                rx="4" fill="rgba(255,255,255,0.95)"/>

          {/* Trend line */}
          <polyline 
            points="29,85 55,65 81,42 107,20"
            stroke="#FFD97D"
            strokeWidth="2.5"
            strokeLinecap="round"
          ...
          {/* Trend dots */}
          <circle cx="29" cy="85" r="4" fill="#FFD97D"/>
          <circle cx="55" cy="65" r="4" fill="#FFD97D"/>
          <circle cx="81" cy="42" r="4" fill="#FFD97D"/>
          <circle cx="107" cy="20" r="4" fill="#FFD97D"/>

          {/* Target rings (right side) */}
          <circle cx="168" cy="65" r="28"
                  stroke="rgba(255,255,255,0.2)"
                  strokeWidth="1.5" fill="none"/>
          <circle cx="168" cy="65" r="19"
                  stroke="rgba(255,255,255,0.4)"
                  strokeWidth="1.5" fill="none"/>
          <circle cx="168" cy="65" r="10"
                  stroke="rgba(255,255,255,0.75)"
                  strokeWidth="2" fill="none"/>
          <circle cx="168" cy="65" r="4"
                  fill="white"/>

          {/* Arrow pointing to target */}
          <line x1="120" y1="40" x2="155" y2="58"
                stroke="#FFD97D" strokeWidth="1.5"
                strokeLinecap="round"
                markerEnd="url(#arrow)"/>
          <defs>
            <marker id="arrow" markerWidth="6" 
                    markerHeight="6" refX="3" refY="3"
                    orient="auto">
              <path d="M0,0 L6,3 L0,6 Z" fill="#FFD97D"/>
            </marker>
          </defs>
        </svg>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          {features.map((feature, i) => (
            <motion.div
              ...
              className={`group bg-white rounded-[28px] overflow-hidden shadow-xl transition-all duration-100 ease-out hover:shadow-2xl ${feature.locked ? 'opacity-90' : ''}`}
